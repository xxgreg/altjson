...
type ProtoMessage interface{ ProtoMessage() }
type ProtoMessageA struct{ A string }
type ProtoMessageB struct{ B string }
type ProtoMessageC struct{ C string }
type ProtoMessageD struct{ D string }
type ProtoMessageE struct{ E string }
type ProtoMessageX struct{ X string }

func (*ProtoMessageA) ProtoMessage() {}
func (*ProtoMessageB) ProtoMessage() {}
func (*ProtoMessageC) ProtoMessage() {}
func (*ProtoMessageD) ProtoMessage() {}
func (*ProtoMessageE) ProtoMessage() {}
func (ProtoMessageX) ProtoMessage()  {}
...
func TestDecoderFuncs(t *testing.T) {
	...
	tests := []struct {
		...
		inJSON:    `{"V": 123456}`,
		wantValue: &struct{ V V }{V{F4: &VOuter{V: V{F1: "123456"}}}},
	}, {
		name: "StructNull",
		funcs: []interface{}{
			func(b []byte, v *V) error {
				// This decoder function is not called since the input is null.
				// This matches the behavior of UnmarshalJSON methods,
				// where there are not called for null either.
				return errors.New("called func([]byte, *V) error, want not called")
			},
		},
		inJSON:    `{"V": null}`,
		wantValue: &struct{ V *V }{nil},
	}, {
		name: "StructPointerNull",
		funcs: []interface{}{
			func(b []byte, v **V) error {
				*v = &V{F4: &VOuter{V: V{F1: string(b)}}}
				return nil
			},
		},
		inJSON:    `{"V": null}`,
		wantValue: &struct{ V *V }{&V{F4: &VOuter{V: V{F1: "null"}}}},
	}, {
		name: "StructAlloc",
		funcs: []interface{}{
			func(b []byte, v *V) error {
				if v == nil {
					return errors.New("v is nil, want non-nil")
				}
				v.F4 = new(VOuter)
				v.F4.V.F1 = string(b)
				return nil
		...
		name: "Slice",
		funcs: []interface{}{
			func(b []byte, v *[]string) error {
				*v = append(*v, string(b))
				return nil
			},
		},
		inJSON:    `{"V": 123456}`,
		wantValue: &struct{ V []string }{[]string{"123456"}},
	}, {
		name: "SliceNull",
		funcs: []interface{}{
			func(b []byte, v *[]string) error {
				...
				// This matches the behavior of UnmarshalJSON methods,
				// where there are not called for null either.
				return errors.New("called func([]byte, *[]string) error, want not called")
			},
		},
		inJSON:    `{"V": null}`,
		wantValue: &struct{ V *[]string }{nil},
	}, {
		name: "SlicePointerNull",
		funcs: []interface{}{
			func(b []byte, v **[]string) error {
				*v = reference([]string{string(b)}).(*[]string)
				return nil
			},
		},
		inJSON:    `{"V": null}`,
		wantValue: &struct{ V *[]string }{reference([]string{"null"}).(*[]string)},
	}, {
		name: "SliceAlloc",
		funcs: []interface{}{
			func(b []byte, v *[]string) error {
		...
		inJSON:    `{"V": 123456}`,
		wantValue: &struct{ V *[]string }{reference([]string{"123456"}).(*[]string)},
	}, {
		name: "Map",
		funcs: []interface{}{
			func(b []byte, v *map[string]bool) error {
		...
		inJSON:    `{"V": 123456}`,
		wantValue: &struct{ V map[string]bool }{map[string]bool{"123456": true}},
	}, {
		name: "MapNull",
		funcs: []interface{}{
			func(b []byte, v *map[string]bool) error {
				...
				// This matches the behavior of UnmarshalJSON methods,
				// where there are not called for null either.
				return errors.New("called func([]byte, *map[string]bool) error, want not called")
			},
		},
		inJSON:    `{"V": null}`,
		wantValue: &struct{ V *map[string]bool }{nil},
	}, {
		name: "MapPointerNull",
		funcs: []interface{}{
			func(b []byte, v **map[string]bool) error {
				*v = new(map[string]bool)
				**v = make(map[string]bool)
				(**v)[string(b)] = true
				return nil
			},
		...
		inJSON:    `{"V": null}`,
		wantValue: &struct{ V *map[string]bool }{reference(map[string]bool{"null": true}).(*map[string]bool)},
	}, {
		name: "MapAlloc",
		funcs: []interface{}{
			func(b []byte, v *map[string]bool) error {
		...
		inJSON:    `{"V": 123456}`,
		wantValue: &struct{ V *map[string]bool }{reference(map[string]bool{"123456": true}).(*map[string]bool)},
	}, {
		name: "MapEntry",
		funcs: []interface{}{
			func(b []byte, v *string) error {
		...
		inJSON:    `{"V": {"key": 123456}}`,
		wantValue: &struct{ V map[string]string }{map[string]string{"key": "123456"}},
	}, {
		name: "MapEntryNull",
		funcs: []interface{}{
			func(b []byte, v *string) error {
		...
		inJSON:    `{"V": {"key": null}}`,
		wantValue: &struct{ V map[string]*string }{map[string]*string{"key": nil}},
	}, {
		name: "MapEntryPointerNull",
		funcs: []interface{}{
			func(b []byte, v **string) error {
				*v = new(string)
				**v = string(b)
		...
		inJSON:    `{"V": {"key": null}}`,
		wantValue: &struct{ V map[string]*string }{map[string]*string{"key": reference("null").(*string)}},
	}, {
		name: "MapEntryAlloc",
		funcs: []interface{}{
			func(b []byte, v *string) error {
		...
		inJSON:    `{"V": {"key": 123456}}`,
		wantValue: &struct{ V map[string]*string }{map[string]*string{"key": reference("123456").(*string)}},
	}, {
		name: "TypeVariance",
		funcs: []interface{}{
			// This decoder function is not called since
		...
		inJSON:    `{"V": "hello"}`,
		wantValue: &struct{ V MyString }{"hello"},
	}, {
		name: "EmbeddedUntagged",
		funcs: []interface{}{
			// This decoder function is not called since U is an embedded field.
			// It matches the behavior where UnmarshalJSON methods are not
			// respected for embedded fields, either.
			func(b []byte, v *U) error {
				return errors.New("called func([]byte, *U) error, want not called")
			},
		},
		inJSON: `{"alpha": "fizzbuzz", "bravo": 5}`,
		wantValue: &struct {
		...
		inJSON: `{"uniform": "fizzbuzz", "bravo": 5}`,
		wantValue: &struct {
		...
		funcs: []interface{}{
			func(b []byte, v ****string) error {
				...
				case v == nil:
					return errors.New("v is nil, want non-nil")
				case *v != nil:
					return errors.New("*v is non-nil, want nil")
				}
				*v = new(**string)
				**v = new(*string)
				***v = new(string)
		...
		inJSON:    `{"V": 12345}`,
		wantValue: &struct{ V ***string }{reference(reference(reference("12345"))).(***string)},
	}, {
		name: "ProtoMessagePointer",
		funcs: []interface{}{
			// This decoder function is only called for the M field.
			// It is not used for ProtoMessageA or *ProtoMessageB since
			// neither are exactly identical to *ProtoMessage.
			func(b []byte, v *ProtoMessage) error {
				*v = ProtoMessageX{string(b)}
				return nil
			},
		},
		inJSON: `{"M": {"M":"M"}, "A": {"A":"A"}, "B": {"B":"B"}}`,
		wantValue: &struct {
			M ProtoMessage
			A ProtoMessageA
			B *ProtoMessageB
		...
		funcs: []interface{}{
			func(b []byte, v ProtoMessage) error {
				...
				case *ProtoMessageE:
					v.E = string(b)
				case *ProtoMessageX:
					// The pointer version of ProtoMessageX is used even though
					// the value form of ProtoMessageX implements ProtoMessage.
					v.X = string(b)
				default:
		...
		wantValue: &struct {
			...
			// The decoder function should not be called since the value is null.
			// This matches the behavior of UnmarshalJSON methods.
			X3 *ProtoMessageX
		}{
			...
			&ProtoMessageB{B: "222"},
			nil, // null does not result in allocation of ProtoMessageC struct; matches behavior for UnmarshalJSON method
		...
		funcs: []interface{}{
			// This decoder function should take precedence over
			// the time.Time.UnmarshalJSON method.
			func(b []byte, v *time.Time) error {
				*v = time.Date(2009, 11, 10, 23, 0, 0, 0, time.UTC)
				return nil
			},
		},
		inJSON:    `{"V": "2020-07-28T13:13:31.266138501Z"}`,
		wantValue: &struct{ V time.Time }{time.Date(2009, 11, 10, 23, 0, 0, 0, time.UTC)},
	}, {
		name: "InterfaceFuncMethodPrecedence",
		funcs: []interface{}{
			// This decoder function should take precedence over
			// the time.Time.UnmarshalJSON method.
			func(b []byte, v encoding.BinaryUnmarshaler) error {
				t := v.(*time.Time)
		...
		funcs: []interface{}{
			// This decoder function is not used since it is listed first
			// and overruled by the next function.
			func(b []byte, v *time.Time) error {
				*v = time.Date(2009, 11, 10, 23, 0, 0, 0, time.UTC)
				return nil
			},
			// This decoder function takes precendence.
			func(b []byte, v *time.Time) error {
				*v = time.Date(2010, 11, 10, 23, 0, 0, 0, time.UTC)
				return nil
			},
			// This decoder function is not used since it operates on an
			// interface type, and concrete types take precedence.
			func(b []byte, v encoding.BinaryUnmarshaler) error {
				t := v.(*time.Time)
				*t = time.Date(2011, 11, 10, 23, 0, 0, 0, time.UTC)
				return nil
			},
		},
		inJSON:    `{"V": "2020-07-28T13:13:31.266138501Z"}`,
		wantValue: &struct{ V time.Time }{time.Date(2010, 11, 10, 23, 0, 0, 0, time.UTC)},
	}, {
		...
		funcs: []interface{}{
			...
			func(b []byte, v encoding.BinaryUnmarshaler) error {
				t := v.(*time.Time)
				*t = time.Date(2010, 11, 10, 23, 0, 0, 0, time.UTC)
				return nil
			},
		},
		inJSON:    `{"V": "2020-07-28T13:13:31.266138501Z"}`,
		...
		inJSON:    `"hello"`,
		wantValue: new(interface{}),
		wantErr:   io.EOF,
	}}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			dec := NewDecoder(strings.NewReader(tt.inJSON))
			for _, fn := range tt.funcs {
				dec.Register(fn)
			}
			gotValue := reflect.New(reflect.ValueOf(tt.wantValue).Type().Elem()).Interface()
			if gotErr := dec.Decode(gotValue); !errors.Is(tt.wantErr, gotErr) {
				t.Errorf("Decode() error: got %v, want %v", gotErr, tt.wantErr)
			}
			if !reflect.DeepEqual(gotValue, tt.wantValue) {
				t.Errorf("Decode() value mismatch:\n\tgot  %v\n\twant %v", gotValue, tt.wantValue)
			}
		})
	}
}

func TestDecoderRegisterPanics(t *testing.T) {
	...
	tests := []struct {
		...
		{func() {}, true},
		{func([]byte) {}, true},
		{func([]byte) error { return nil }, true},
		{func([]byte, []byte) error { return nil }, true},
		{func([]byte, *[]byte) error { return nil }, false},
		{func([]byte, *int) error { return nil }, false},
		{func([]byte, *bytes.Buffer) error { return nil }, false},
		{func([]byte, **bytes.Buffer) error { return nil }, false},
		{func([]byte, **interface{}) error { return nil }, false},
		{func([]byte, io.Writer) error { return nil }, false},
		{func([]byte, interface{}) error { return nil }, true},
		{func([]byte, *interface{}) error { return nil }, false},
		{func([]byte, MyInterface) error { return nil }, true},
		{func([]byte, *interface{}) MyError { return nil }, true},
		{func(MyBytes, *interface{}) error { return nil }, true},
		{func([]byte, interface{ ProtoMessage() }) error { return nil }, false},
		{func([]byte, *interface{ ProtoMessage() }) error { return nil }, false},
		{func([]byte, **interface{ ProtoMessage() }) error { return nil }, false},
		{func([]byte, ***interface{ ProtoMessage() }) error { return nil }, false},
	}
	...
	for _, tt := range tests {
		...
		func() {
			...
			dec := NewDecoder(nil)
			dec.Register(tt.inFunc)
		}()
		switch {
		case gotPanic && !tt.wantPanic:
			t.Errorf("Decoder.Register(%T) did panic, want no panic", tt.inFunc)
		case !gotPanic && tt.wantPanic:
			t.Errorf("Decoder.Register(%T) did not panic, want panic", tt.inFunc)
		}
	}
}
